...
export declare const tagColorSchema: z.ZodEnum<["gray", "red", "orange", "yellow", "green", "teal", "blue", "indigo", "purple", "pink"]>;
...
export declare const itemMoveSchema: z.ZodEffects<z.ZodObject<{
...
export declare const tagCreateSchema: z.ZodObject<{
    name: z.ZodString;
    color: z.ZodDefault<z.ZodEnum<["gray", "red", "orange", "yellow", "green", "teal", "blue", "indigo", "purple", "pink"]>>;
}, "strip", z.ZodTypeAny, {
    name: string;
    color: "gray" | "red" | "orange" | "yellow" | "green" | "teal" | "blue" | "indigo" | "purple" | "pink";
}, {
    name: string;
    color?: "gray" | "red" | "orange" | "yellow" | "green" | "teal" | "blue" | "indigo" | "purple" | "pink" | undefined;
}>;
export declare const tagPatchSchema: z.ZodObject<{
    name: z.ZodOptional<z.ZodString>;
    color: z.ZodOptional<z.ZodEnum<["gray", "red", "orange", "yellow", "green", "teal", "blue", "indigo", "purple", "pink"]>>;
}, "strip", z.ZodTypeAny, {
...
export declare const viewPatchSchema: z.ZodObject<{
    ...
    sort: z.ZodOptional<z.ZodOptional<z.ZodNullable<z.ZodObject<{
        field: z.ZodEnum<["title", "modified", "created", "updated"]>;
        dir: z.ZodEnum<["asc", "desc"]>;
    }, "strip", z.ZodTypeAny, {
        field: "created" | "updated" | "modified" | "title";
...
export declare const DRIVE_NATIVE_MIMES: readonly ["application/vnd.google-apps.document", "application/vnd.google-apps.spreadsheet", "application/vnd.google-apps.presentation", "application/vnd.google-apps.drawing", "application/vnd.google-apps.form", "application/vnd.google-apps.script", "application/vnd.google-apps.site", "application/vnd.google-apps.folder"];
export type DriveNativeMime = (typeof DRIVE_NATIVE_MIMES)[number];
export declare const driveCreateSchema: z.ZodObject<{
    name: z.ZodString;
    mime_type: z.ZodEnum<["application/vnd.google-apps.document", "application/vnd.google-apps.spreadsheet", "application/vnd.google-apps.presentation", "application/vnd.google-apps.drawing", "application/vnd.google-apps.form", "application/vnd.google-apps.script", "application/vnd.google-apps.site", "application/vnd.google-apps.folder"]>;
    ...
    name: string;
    mime_type: "application/vnd.google-apps.document" | "application/vnd.google-apps.spreadsheet" | "application/vnd.google-apps.presentation" | "application/vnd.google-apps.drawing" | "application/vnd.google-apps.form" | "application/vnd.google-apps.script" | "application/vnd.google-apps.site" | "application/vnd.google-apps.folder";
    create_page: boolean;
...
export declare const permissionCreateSchema: z.ZodEffects<z.ZodObject<{
